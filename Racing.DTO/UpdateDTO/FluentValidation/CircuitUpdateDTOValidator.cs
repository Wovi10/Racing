...
{
    public class CircuitUpdateDTOValidator : AbstractValidator<CircuitUpdateDTO>
    {
        public CircuitUpdateDTOValidator(IStringLocalizer<CreateDTOMessages> localizer)
        {
